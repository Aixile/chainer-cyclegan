...
class lsun_bedroom_line2color_train(datasets_base):
    def __init__(self, dataset_path=paths.lsun_bedroom, flip=1, resize_to=172, crop_to=128):
        super(lsun_bedroom_line2color_train, self).__init__(flip=flip, resize_to=resize_to, crop_to=crop_to)
        self.all_keys = self.read_image_key_file_json(paths.lsun_bedroom + paths.all_keys_lsun_bedroom_train)
